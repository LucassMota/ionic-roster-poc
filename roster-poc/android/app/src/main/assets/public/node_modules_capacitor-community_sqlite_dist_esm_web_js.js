"use strict";
(self["webpackChunkapp"] = self["webpackChunkapp"] || []).push([["node_modules_capacitor-community_sqlite_dist_esm_web_js"],{
...
class CapacitorSQLiteWeb extends _capacitor_core__WEBPACK_IMPORTED_MODULE_1__.WebPlugin {
  constructor() {
    super(...arguments);
  ...
  getFromHTTPRequest(options) {
    ...
    return (0,C_Estudos_ionic_roster_poc_roster_poc_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      try {
        yield _this29.jeepSqliteElement.getFromHTTPRequest(options);
        return;
      } catch (err) {
        throw new Error(`${err}`);
      }
  ...
  getDatabaseList() {
    ...
    return (0,C_Estudos_ionic_roster_poc_roster_poc_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      _this30.ensureJeepSqliteIsAvailable();

      _this30.ensureWebstoreIsOpen();

      try {
        const databaseListResult = yield _this30.jeepSqliteElement.getDatabaseList();
  ...
  isNCDatabase(options) {
    ...
    return (0,C_Estudos_ionic_roster_poc_roster_poc_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
      ...
      throw _this43.unimplemented('Not implemented on web.');
    })();
  }
...
//# sourceMappingURL=node_modules_capacitor-community_sqlite_dist_esm_web_js.js.map